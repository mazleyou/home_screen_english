...
import com.example.android.appwidget.glance.weather.WeatherWorker

class HSEWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget = HSEWidget()
